...
RSpec.describe "MultiVolumeWorksController", type: :feature do
  ...
  it "User can create a new scanned resource attached to the multi-volume work" do
    visit polymorphic_path [multi_volume_work]
    ...
    have_current_path("/concern/parent/#{multi_volume_work.id}/scanned_resources/", only_path: true)
